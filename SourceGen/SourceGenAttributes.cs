...
/// <br /> See <see cref="Parsing.WriteArgumentBytes"/> to understand how arguments are parsed and which types are supported.
...
/// <summary>
/// Registers a <see cref="GameResources.GameResource"/> field along with <paramref name="path"/>, such that providing the enclosing type to <see cref="StaticMetadata.LoadStaticResourceReferencesFor{T}"/> or <see cref="StaticMetadata.DeloadStaticResourceReferencesFor{T}"/> loads or deloads the resources without needing an instance or even concrete type.
